...
import com.phannpha.android.breacking.news.databinding.ItemBrowsByLayoutBinding
...
class ItemBrowsByAdapter(
	private val category: ArrayList<CategoryModel>,
	private val onClick: OnItemCategoryListener
) :
	RecyclerView.Adapter<ItemBrowsByAdapter.ViewHolder>() {

	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
		val layoutInflater = LayoutInflater.from(parent.context)
		val binding = ItemBrowsByLayoutBinding.inflate(layoutInflater, parent, false)
	...
	inner class ViewHolder(private val binding: ItemBrowsByLayoutBinding) :
